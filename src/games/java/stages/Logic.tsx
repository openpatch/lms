...
import type { LogicQuestion } from "../../../../shared/games/java";
...
export default function LogicStage({ question, submit }: StageProps<LogicQuestion>) {
  ...
  if (question.kind === "reading") {
    return (
      ...
      >
        <p className="text-center text-gray-500">{t("games.java.readingPrompt")}</p>
