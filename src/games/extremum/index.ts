...
import { DeriveReview, OptimizeClassAnswers, OptimizeReview } from "./stages/reviews";
...
export default defineGame(extremumSpec, {
  ...
  optimize: {
    Component: OptimizeStage,
    RulesExample: OptimizeRulesExample,
    Review: OptimizeReview,
    ClassAnswers: OptimizeClassAnswers,
  },
});
