...
import { ArrangeReview, CalculateReview, ChangeReview, SignsReview } from "./stages/reviews";
...
export default defineGame(rationalSpec, {
  arrange: { Component: ArrangeStage, RulesExample: ArrangeRulesExample, Review: ArrangeReview },
