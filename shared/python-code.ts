// Reading what a student typed as the output of a Python program.
//
// A stage asks "what does this print?", so the answer is a value, not a term:
// the grading is about the value the program produces, not about how it is
// spelled. These helpers make the obvious spellings equal — a comma for the
// decimal point, `7` for `7.0`, `wahr` for `True` — and leave everything else
// to be simply wrong.
